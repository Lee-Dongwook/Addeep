...
export const slideData = [
  ...
  },
  {
    title: "",
    text: [
      '우리의 비전은 우리의 비즈니스 모델인 "Global Addeep Platform"이',
      "공존의 가치를 만들어가고,",
      "AGI 기반의 스마트한 플랫폼과 콘텐츠 서비스를 공정하고 자유롭고 편리하게 이용할 수 있도록 제공하는 것입니다.",
      "우리 모두가 바람직한 협력과 개인의 상상으로 미래를 만들어가며,",
      "이용자 모두가 편리한 서비스 플랫폼 기술을 한 걸음 먼저 체험하게 하여,",
      "우리 생활에 유용하고 편리하며 꼭 필요한 서비스를 사람과 사람이 함께",
      "나눌 수 있도록 혁신적인 방법으로 제공하는 것이",
      "바로 Addeep의 목표입니다.",
    ],

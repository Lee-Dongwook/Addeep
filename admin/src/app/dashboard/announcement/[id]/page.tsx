      ...
      <div className="max-w-5xl mx-auto animate-fade-in">
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-white rounded-2xl p-6 shadow-medium border border-dark-100">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary-100 text-primary-700 rounded-lg text-sm font-semibold mb-3">
                <svg
                  className="w-4 h-4"
                  fill="none"
                  stroke="currentColor"
              ...
              <p className="text-dark-600 text-sm">
                작성일: {formatDate(AnnouncementDetail.created_at)}
              </p>
            </div>
